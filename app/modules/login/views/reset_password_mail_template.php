...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    *:not(br):not(tr):not(html) {
	...
	<body>
		<span class="preheader">Token Reset Password hanya berlaku 24 jam.</span>
								...
								<table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td class="content-cell">
											...
											<p>Untuk keamanan, apabila Anda tidak merasa melakukan permintaan reset password ini, tolong abaikan email ini. Anda dapat menghubungi kami melalui email <strong>info@gaji.up45.ac.id</strong> jika ada pertanyaan.</p>
											<p>Terimakasih,
