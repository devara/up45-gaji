								...
								<table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="100%" style="margin:0 auto;">
									<tr>
										<td style="font-size: 24px; text-align:center;">
											<br>
												Sistem Penggajian Universitas Proklamasi 45
											<br>
											<br>
										</td>
									</tr>
											...
											<center>
												<table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="60%">
													<tr>
														...
														<br>
														 Terimakasih. Anda baru saja melakukan permintaan untuk Aktivasi Akun Sistem Informasi Penggajian Universitas Proklamasi 45
														<br>
														<br>
														</td>
													</tr>
										...
										<td>
											<div><!--[if mso]>
												<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="8%" stroke="f" fillcolor="#178f8f">
													...
													<center>
												<![endif]-->
														<a href="<?=base_url()?>aktivasi-akun?tokenRef=<?=$token?>"
											style="background-color:#178f8f;border-radius:4px;color:#ffffff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Aktivasi Akun!</a>
												<!--[if mso]>
													</center>
												</v:roundrect>
											<![endif]--></div>
