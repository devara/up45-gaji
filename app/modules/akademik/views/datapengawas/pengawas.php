	...
	<div>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>Manajemen Data Pengawas (UTS/UAS)</h2>
            ...
            <div class="clearfix"></div>
                ...
                <li role="presentation" class="<?php if($aktifTab == 'pengawas'): ?> active <?php endif; ?>" id="li-pengawas">
                	<a href="#pengawas" id="pengawas-tab" role="tab" data-toggle="tab" aria-expanded="false">Input Pengawas UTS/UAS</a>
                </li>
              ...
              <div id="myTabContent" class="tab-content">
              	...
              	<div role="tabpanel" class="tab-pane fade <?php if($aktifTab == 'pengawas'): ?> active in <?php endif; ?>" id="pengawas" aria-labelledby="pengawas-tab">
              		<form id="demo-form" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="<?=akademik()?>pengawas/input_pengawas">
              			<div class="form-group">
              				...
              				<div class="col-md-6 col-sm-6 col-xs-12">
              					<select name="periode" id="periode" class="select2_single form-control" required="" title="Pilih Periode" onchange="get_ujian()">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="ujianlist" id="ujianlist" class="select2_single form-control" required="required" title="Pilih Ujian">
