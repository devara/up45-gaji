	...
	<div>
		<div class="page-title">
			<div class="title_left">
				<h3>Pengawas dan Korektor Ujian</h3>
			</div>
		</div>
						...
						<div>
							<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
								...
								<div class="form-group">
									<label class="control-label col-md-2 col-sm-3 col-xs-12" for="elemen">Pilih Elemen <span class="required">*</span></label>
									<div class="col-md-4 col-sm-6 col-xs-12">
										<select class="form-control" name="elemen" id="elemen" required="required">
					          	<option selected="" disabled="">Pilih</option>
					          	<option value="pengawas">Pengawas Ujian</option>
					          	<option value="korektor">Korektor Ujian</option>
					          </select>
									</div>
								</div>
								<div class="form-group">
